# [KG Starter Theme](http://www.konradgroup.com)

[![Built with Grunt](https://cdn.gruntjs.com/builtwith.png)](http://gruntjs.com/)

KG Starter Theme is based on Roots.

Roots is a WordPress starter theme based on [HTML5 Boilerplate](http://html5boilerplate.com/) & [Bootstrap](http://getbootstrap.com/) that will help you make better themes.

## Installation

Clone the git repo - `https://konradgroup.git.beanstalkapp.com/kg-web-starter-wordpress.git` - and then rename the directory to the name of your theme or website. [Install Grunt](http://gruntjs.com/getting-started), and then install the dependencies for Roots contained in `package.json` by running the following from the Roots theme directory:
...
We also need to make sure to update this repo with Roots updates every major version.