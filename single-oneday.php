...
<div class="single">
    <div class="header singleOneDayHeader small-banner center">
        <div class="img-header-content center">
            <h1 class="title t1 white text-center">ONE <span class="white"> DAY TOUR</span></h1>
        </div>
    </div>
    ...
    <div class="content-medium">
        ...
        <label><h2>Price:    </h2> </label><span class="subtitle">    $<?php echo get_field("oneday_price"); ?></span>
